...
export default function Home() {
  return (
    <section className='pb-[50%] pt-[50%]  md:pb-48 lg:pb-64 md:pt-16 md:relative bg-zinc-50 to-transparent z-10'>
    <div className='max-w-7xl mx-auto px-4 sm:px-6 md:px-8'>
      ...
      <div className='hidden lg:block'>
        <img src="img/background/bg-1.png" alt="bg-home" className=" absolute top-0 left-0 t-0 -z-0 lg:mt-[-2%]"/>
